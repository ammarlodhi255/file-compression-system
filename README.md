...
We have provided an executable .jar as well as .exe file inside the folder named "Executable file" in which you will find files named "EncodorGUI.jar" and "Encoder.exe".
